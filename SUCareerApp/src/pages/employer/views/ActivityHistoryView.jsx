  ...
  if (activities.length === 0) {
    return (
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ backgroundColor: '#ffffff', borderRadius: '10px', border: '1px solid #e2e8f0', padding: '40px', textAlign: 'center', color: '#94a3b8' }}>
          No activity recorded yet. Post a job to get started.
        </div>
      </div>
    );
  }
